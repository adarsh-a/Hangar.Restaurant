...
namespace Hangar.Restaurant.Controllers
{
    public class MenuPageController : Controller
    {
        ...
        public MenuPageController(IRepository<MenusEntity> Context, IRepository<MenuTypeEntity> typeContext, IRepository<SpecialMenuEntity> specialContext)
        {
            menusContext = Context;
            menuTypeContext = typeContext;
            specialMenuContext = specialContext;
        }
        public ActionResult MenusPage()
        {
            ...
            return PartialView("~/Views/PartialView/MenuLayout.cshtml", viewModel);
        }
    }
}